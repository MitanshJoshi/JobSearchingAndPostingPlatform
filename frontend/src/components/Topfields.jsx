...
const Topfields = () => {
  ...
  return (
    <div className='flex flex-col items-center'>
        <h3 className="text-3xl font-semibold text-center mb-10">Top Niches</h3>
      <div className='grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4 w-full max-w-screen-lg p-4'>
        {services.map((item) => (
          <div key={item.id} className='p-4 bg-primary3 rounded-lg shadow-md hover:text-white hover:bg-black'>
