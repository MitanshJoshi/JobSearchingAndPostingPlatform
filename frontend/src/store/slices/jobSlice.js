...
export const fetchJobs =
  ...
  async (dispatch) => {
    try {
      ...
      let link = "https://job-api-five.vercel.app/api/v1/job/getall?";
      let queryParams = [];
      if (searchKeyword) {
...
export const fetchSingleJob = (jobId) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://job-api-five.vercel.app/api/v1/job/get/${jobId}`,
...
export const postJob = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `https://job-api-five.vercel.app/api/v1/job/postjob`,
      data,
...
export const getMyJobs = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://job-api-five.vercel.app/api/v1/job/getmyjobs`,
      { withCredentials: true }
    );
...
export const deleteJob = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://job-api-five.vercel.app/api/v1/job/delete/${id}`,
      { withCredentials: true }
    );
